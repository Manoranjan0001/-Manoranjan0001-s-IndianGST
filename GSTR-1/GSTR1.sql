...
with GSTR1 as
(
select * from [dbo].[GSTR-1-2017-2018]

union
select * from [dbo].[GSTR-1-2018-2019]
union 
select * from [dbo].[GSTR-1-2019-2020]
union
select * from [dbo].[GSTR-1-2020-2021]
union 
select * from [dbo].[GSTR-1-2021-2022]
union 
select * from [dbo].[GSTR-1-2022-2023]
...
select year as [Financial Year],STATE as State,sum(coalesce(No_of_Tax_Payers_eligible_to_File,0))+sum(coalesce(No_of_Tax_Payers_eligible_to_File2,0))+sum(coalesce(No_of_Tax_Payers_eligible_to_File3,0))+
							...
							sum(coalesce(No_of_Tax_Payers_eligible_to_File10,0))+sum(coalesce(No_of_Tax_Payers_eligible_to_File11,0))+sum(coalesce(No_of_Tax_Payers_eligible_to_File12,0)) Num_Tax_Payers_eligible_to_File ,
			...
			sum(coalesce(No_Tax_Payers_filed_by_Due_Date4,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date5,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date6,0))+
			sum(coalesce(No_Tax_Payers_filed_by_Due_Date7,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date8,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date9,0))+
			sum(coalesce(No_Tax_Payers_filed_by_Due_Date10,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date11,0))+sum(coalesce(No_Tax_Payers_filed_by_Due_Date12,0)) Num_Tax_Payers_filed_by_Due_Date,
			...
			sum(coalesce(No_of_Tax_Payers_filed_after_due_date10,0))+sum(coalesce(No_of_Tax_Payers_filed_after_due_date11,0))+sum(coalesce(No_of_Tax_Payers_filed_after_due_date12,0)) Num_Tax_Payers_filed_after_due_date,
			...
			sum(coalesce(Total_Returns_Filed9,0))+sum(coalesce(Total_Returns_Filed10,0))+sum(coalesce(Total_Returns_Filed11,0))+sum(coalesce(Total_Returns_Filed12,0)) Total_Returns_Filed
